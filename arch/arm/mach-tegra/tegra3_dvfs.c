...
static struct dvfs cpu_dvfs_table[] = {
	...
	/* Nexus 7 -> check nominal voltage in cpu_speedo_nominal_millivolts[] (tegra3_speedo.c) for determining the TOP slot */
	/* Cpu voltages (mV):	      800, 825, 850, 875,  900,  912,  975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1212, 1237 */
	CPU_DVFS("cpu_g",  7, 0, MHZ, 460, 460, 550, 550,  680,  680,  820,  970, 1040, 1080, 1150, 1200, 1270, 1320, 1400, 1500, 1600, 1700),
	CPU_DVFS("cpu_g",  7, 1, MHZ, 480, 480, 650, 650,  780,  780,  990, 1040, 1100, 1200, 1300, 1370, 1420, 1500, 1600, 1700),
	CPU_DVFS("cpu_g",  7, 2, MHZ, 520, 520, 700, 700,  860,  860, 1050, 1150, 1200, 1300, 1370, 1420, 1500, 1600, 1700),
	CPU_DVFS("cpu_g",  7, 3, MHZ, 550, 550, 770, 770,  910,  910, 1150, 1230, 1300, 1370, 1420, 1500, 1600, 1700),
	CPU_DVFS("cpu_g",  7, 4, MHZ, 550, 550, 770, 770,  940,  940, 1160, 1300, 1370, 1420, 1500, 1600, 1700),
...
static struct dvfs core_dvfs_table[] = {
	...
	/* Nexus 7 -> 520MHz GPU */
	CORE_DVFS("vde",    1, 1, KHZ,        1, 247000, 304000, 352000, 437000,  520000,  520000,  520000,  520000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 247000, 304000, 361000, 446000,  520000,  520000,  520000,  520000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 304000, 361000, 446000,  520000,  520000,  520000,  520000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 304000, 361000, 446000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 247000, 304000, 361000, 446000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 247000, 304000, 361000, 446000,  520000,  520000,  520000,  520000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 304000, 361000, 446000,  520000,  520000,  520000,  520000),
	...
	/* Nexus 7 -> 520MHz GPU */
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 247000, 304000, 361000, 446000,  520000,  520000,  520000,  520000),
	...
	CORE_DVFS("dsia",  -1, 1, KHZ,        1, 432500, 432500, 432500, 432500, 432500,  432500,   275000,  275000),
	CORE_DVFS("dsib",  -1, 1, KHZ,        1, 432500, 432500, 432500, 432500, 432500,  432500,   275000,  275000),
