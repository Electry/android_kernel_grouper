...
static struct dvfs cpu_dvfs_table[] = {
	...
	/* This is our initialized AP33/T30 variant -> w Turbo Boost*/
...
static struct dvfs core_dvfs_table[] = {
	...
	/* This is our initialized AP33/T30 variant */
	...
	/* This is our initialized AP33/T30 variant */
	CORE_DVFS("emc",    1, 1, KHZ,   102000, 408000, 408000, 408000, 408000,  800000,  800000,  800000,  800000),
	...
	/* This is our initialized AP33/T30 variant -> 600MHz*/
	CORE_DVFS("vde",    1, 1, KHZ,        1, 247000, 304000, 400000, 520000,  600000,  600000,  600000,  600000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 247000, 304000, 400000, 520000,  600000,  600000,  600000,  600000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 304000, 400000, 520000,  600000,  600000,  600000,  600000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 304000, 400000, 520000,  600000,  600000,  600000,  600000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 247000, 304000, 400000, 520000,  600000,  600000,  600000,  600000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 247000, 304000, 400000, 520000,  600000,  600000,  600000,  600000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 304000, 400000, 520000,  600000, 600000,  600000,  600000),
	...
	/* This is our initialized AP33/T30 variant -> 600MHz*/
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 247000, 304000, 400000, 520000,  600000,  600000,  600000,  600000),
