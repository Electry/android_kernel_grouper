...
static char __initdata tegra_edp_map[] = {
	 ...
	 *
	 * HUGE thanks to Hundsbuah@xda for showing
	 ...
	 * core_cap = mhz/10
	 *
	 * Basically here is implemented the whole "Turbo Boost" idea of this kernel
	 */
	/*
	 *   This is our regulator (<= 0x3c)
	 */
	/* speedo_id,  regulator,  temp_zone,  core0_cap,  core1_cap,  core2_cap,  core3_cap */
	   0x07,       0x3b,       0x17,       0x96,       0x8c,       0x82,       0x78,        /* 23 C - 1500 MHz - 1400 MHz - 1300 MHz - 1200 MHz - This one is for cold boot */
	   0x07,       0x3b,       0x2d,       0xaa,       0xa0,       0x96,       0x8c,        /* 45 C - 1700 MHz - 1600 MHz - 1500 MHz - 1400 MHz */
	   0x07,       0x3b,       0x3c,       0xaa,       0xa0,       0x96,       0x8c,        /* 60 C - 1700 MHz - 1600 MHz - 1500 MHz - 1400 MHz */
	   0x07,       0x3b,       0x4b,       0x96,       0x8c,       0x82,       0x78,        /* 75 C - 1500 MHz - 1400 MHz - 1300 MHz - 1200 MHz */
	   0x07,       0x3b,       0x5a,       0x82,       0x78,       0x78,       0x78,        /* 90 C - 1300 MHz - 1200 MHz - 1200 MHz - 1200 MHz */
	/*
